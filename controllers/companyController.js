...
exports.createCompany = async (req, res) => {
  ...
  try {
    const { username,legalname, contact,description, email, password, role, status } = req.body;
    ...
    // Create a new company
    const newCompany = new Company({ username,legalname, contact, description, email, password: hashedPassword, role , status});
